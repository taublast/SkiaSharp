import { config as unoConfig } from "/SkiaSharp/gallery-uno/package_5947537d7caf45d2b637e3d7377d5ca7521a9741/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('05900913-7f0e-4e42-b7f4-c056277bf86a').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '05900913-7f0e-4e42-b7f4-c056277bf86a';
