import { config as unoConfig } from "/SkiaSharp/fiddle/package_c8a384c05416d6da538f06f23408d037c31057f6/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('7287c6ae-7d80-4abd-93a7-0fba4e219977').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '7287c6ae-7d80-4abd-93a7-0fba4e219977';
